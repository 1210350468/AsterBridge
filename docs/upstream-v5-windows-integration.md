...
- helper/Launcher-level physical-settlement ownership and progress forwarding from the later `a3a5083` evolution; the 3.0.40 release intentionally stopped at the daemon/session boundary rather than importing that broader helper rewrite;
