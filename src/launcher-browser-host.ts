...
export async function selectLauncherPage(
  ...
  do {
    ...
    // Browser-process target metadata stays queryable even when a renderer is busy or paused.
    // Avoid executing JavaScript in every candidate page merely to rediscover ownership.
