...
export function resolveChatGptWebModelMode(
  ...
  switch (effort) {
    case "low":
      return { modelId, effort, displayLabel: "Instant", uiEffortIndex: 0, thinkEnabled: false, localTools: capabilities.localToolsEnabled, connectorTools: capabilities.localToolsEnabled && capabilities.localToolTransport !== "responses" };
    case "medium":
      return { modelId, effort, displayLabel: "Medium", uiEffortIndex: 1, thinkEnabled: false, localTools: capabilities.localToolsEnabled, connectorTools: capabilities.localToolsEnabled && capabilities.localToolTransport !== "responses" };
    case "high":
    ...
    case "max":
      ...
      return { modelId, effort, displayLabel: "Pro", uiEffortIndex: 4, thinkEnabled: false, localTools: capabilities.localToolsEnabled, connectorTools: capabilities.localToolsEnabled && capabilities.localToolTransport !== "responses" };
    default:
