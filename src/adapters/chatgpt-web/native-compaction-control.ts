 ...
 * compaction. Canonical results that Codex already owns stay byte-for-byte unchanged; the retained
 * conversation receives the one structured checkpoint request only after the ordinary response
