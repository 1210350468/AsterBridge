...
/** Native compaction defines a new retained ChatGPT conversation epoch. */
...
/** Full Codex history remains canonical; a retained browser receives only the new suffix. */
