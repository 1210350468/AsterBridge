...
const en = {
  ...
  supportBody: "Star the repository and share AsterBridge so more developers can discover the project.",
  star: "Star on GitHub",
  ...
  roxyAutoOpenBody: "When the profile is closed, use RoxyBrowser Local API to open it before starting the ChatGPT turn.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  continue: "继续",
  supportTitle: "开始之前",
  supportBody: "欢迎为仓库 Star，并分享 AsterBridge · 星桥，让更多开发者发现这个项目。",
  ...
  roxyAutoOpenBody: "Profile 未打开时，通过 RoxyBrowser Local API 先启动该 Profile，再开始 ChatGPT 回合。",
  roxyApiHost: "RoxyBrowser Local API",
  roxyApiKey: "RoxyBrowser API Key",
