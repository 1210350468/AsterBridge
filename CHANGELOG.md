...
- Exact Windows package `asterbridge-3.0.30-win-x64.exe` is **151,545,003 bytes** with a **157,949-byte** blockmap and SHA-256 `49DFE0373AF8209A84EB9282772BEC383A95FAD45992AC7B1D10B92671E97466`; packaged smoke passed with `PACKAGED_LAUNCHER_SMOKE_OK win32/x64`. Installed 3.0.30 returned Full/MCP health with `active_http_turns=0` and `active_browser_turns=0` after the soak.
